# 🏢 Campus Counsel (AI Admission Guide)

> Admission assistant answering registration steps. Sends reminders to Telegram student chats.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/campus-counsel/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-campus-counsel.git
cd tp-campus-counsel
```
...
```bash
kubectl port-forward deployment/tp-campus-counsel 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── campus_counsel.py     # Main configuration file
```
...
---
*Generated by [Campus Counsel (AI Admission Guide) Studio](https://pradeeptalari14.github.io/portfolio/tools/campus-counsel/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
